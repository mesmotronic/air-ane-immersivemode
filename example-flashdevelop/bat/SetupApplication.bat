...
:: Android packaging
set AND_CERT_NAME="ImmersiveModeTest"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\certificate.p12
...
set IOS_PROVISION=cert\ImmersiveModeTest.mobileprovision
...
set APP_ID=com.mesmotronic.ane.immersivemode.test

:: Output packages
set DIST_PATH=dist
set DIST_NAME=ImmersiveModeTest
